		...
		<main class="main_app_container">
			...
			<div class="">
				...
				<div class="new_job_add_choose_option_item">
					<label for=""><span>Job ad with standard design</span><input type="radio" name="company_job_type_add"  checked="checked" value="job_ad_standard_design"></label>

					<label for="">
						<span>Job ad with custom text formatting and image</span><input type="radio" name="company_job_type_add"  value="job_ad_custom_text_and_img">
						<span class="new_job_add_desc bold none">This option is available for Silver, Gold, Platinum, Diamond job offers.</span>
					</label>

					<label for="">

						<span>Job ad with fully customizable design</span><input type="radio" name="company_job_type_add"  value="job_ad_full_custom_design">
			...
			<form action="" method="" class="new_job_add_choose_form" style="display: none;">
				...
				<div class="new_job_add_choose_form_item">
					...
					<select name="person_responsible" id="">
				...
				<div class="new_job_add_choose_form_item cf">
					...
					<select id="" class="selectSectorSelected select_move_area" name="category" size="5">
				...
				<div class="new_job_add_choose_form_item">
					...
					<label for="company_job_type" style="margin-right: 20px"><span>Permanent</span> <input type="radio" name="company_job_type" ></label>
					<label for="company_job_type" style="margin-right: 20px"><span>Temporary</span> <input type="radio" name="company_job_type" ></label>
					<label for="company_job_type" style="margin-right: 20px"><span>Internship</span> <input type="radio" name="company_job_type" ></label>
					<label for="company_job_type" style="margin-right: 20px"><span>Distance job</span> <input type="radio" name="company_job_type" ></label>

					<p class="form_title" style="margin-top: 20px;">Term:</p>
					<label for="terms_job" style="margin-right: 20px"><span>Full time</span> <input type="checkbox" name="terms_job" value="0" ></label>
					<label for="terms_job" style="margin-right: 20px"><span>Part time</span> <input type="checkbox" name="terms_job" value="1"></label>

					<p class="form_title" style="margin-top: 20px;">Career level:</p>
					<label for="career_level" style="margin-right: 20px"><span>Management</span> <input type="radio" name="career_level" value="" ></label>
					<label for="career_level" style="margin-right: 20px"><span>Experts</span> <input type="radio" name="career_level" value="" ></label>
					<label for="career_level" style="margin-right: 20px"><span>Administrative Staff/Workers</span> <input type="radio" name="career_level" value="" ></label>

					<p class="form_title" style="margin-top: 20px;">Additional options::</p>
					<label for="add_options" style="margin-right: 20px"><span>Suitable also for students</span> <input type="checkbox" name="for_students" value="1" ></label>
					<br>
					<label for="add_options" style="margin-right: 20px"><span>Suitable also for candidates with little or no experience</span> <input type="checkbox" name="low_experience"  value="1"></label>
				...
				<div class="new_job_add_choose_form_item">
					...
					<label for="add_options" style="margin-right: 20px;display: block;margin-top: 20px;"><input type="checkbox" name="visibility" value="1"><span> Additional visibility of the job offer in a location different from the work location (optional)</span></label>
				...
				<div class="new_job_add_choose_form_item">
					...
					<label for=""></label><input type="text" name="languages">
				...
				<div class="new_job_add_choose_form_item">
					...
					<select name="questionnaire">
						<option value="id of questionnaire 1">Name1</option>
					</select>
