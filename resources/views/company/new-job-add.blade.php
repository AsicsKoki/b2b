...
<h1 class="page_title">New job ad</h1>
		...
		<main class="main_app_container">
			...
			<div class="new_job_add_choose_option">
				<p class="form_title">Your company / organisation is:</p>
				<div class="new_job_add_choose_option_item">
					<label for=""><span>Job ad with standard design</span><input type="radio" name="company_job_type_add" id=""></label>
					<label for=""><span>Job ad with custom text formatting and image</span><input type="radio" name="company_job_type_add" id=""></label>
					<label for=""><span>Job ad with fully customizable design</span><input type="radio" name="company_job_type_add" id=""></label>
					<label for=""><span>Confidential job ad</span><input type="radio" name="company_job_type_add" id=""></label>
				</div>
			</div>
