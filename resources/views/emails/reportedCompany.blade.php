                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 54px; font-weight: 300; letter-spacing: -1.5px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 54px; font-weight: 300; letter-spacing: -1.5px;">Reported Company</span>
                                    </font>
                                    ...
                                    <font face="'Source Sans Pro', sans-serif" color="#000000" style="font-size: 20px; line-height: 28px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 20px; line-height: 28px;">
                                            <a href="" style="color: #ff5b5c;margin-bottom: 30px;">{{ $user->first_name }} {{ $user->last_name }}</a>, has been reported for miscunduct.
                                         </span>
                                    </font>

                                    <div style="height: 30px; line-height: 6px; font-size: 4px;">&nbsp;</div>
