                            ...
                            <tr>
                                <td align="left" valign="top">
                                    <font face="'Source Sans Pro', sans-serif" color="#1a1a1a" style="font-size: 52px; line-height: 54px; font-weight: 300; letter-spacing: -1.5px;">
                                        <span style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 54px; font-weight: 300; letter-spacing: -1.5px;">Approved Ad</span>
                                    </font>
                             ...
                             {{ $user->first_name }} {{ $user->last_name }} ,<br> your job ad on <a href="" style="color: #ff5b5c;">Naposao.rs</a> has been approved by administrator. You can see it here:
                              </span>
                                    </font>
